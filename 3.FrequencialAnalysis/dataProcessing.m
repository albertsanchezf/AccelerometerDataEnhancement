...
[x,y,z] = resampleSignalsv2(inx,lengths,Acc_X,Acc_Y,Acc_Z,Incident_Type,nSignals);
...
hp1 = designfilt('highpassfir','StopbandFrequency',0.25, ...
         ...
         'StopbandAttenuation',120,'SampleRate',Fs,'DesignMethod','kaiserwin');
